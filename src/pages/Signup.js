...
function Signup() {
  ...
  async function uploadImage(){
    ...
    data.append('upload_preset', 'tfazzswl');
    try {
      setUploadingImg(true);
      let res = await fetch('https://api.cloudinary.com/v1_1/dyzoutc9l/image/upload', {
        method: 'post',
        body: data
      })
    ...
    <Row>
      ...
      <Form style={{ width: '80%', maxWidth: 500 }} onSubmit={handleSignup}>
        ...
        <div className="signup-profile-pic_container">
          <img src={imagePreview || profile} alt="profilepicture" className="signup-profile-pic" />
